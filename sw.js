const CACHE_NAME = 'j11-tutor-v28';
const ASSETS = [
  '/',
  '/index.html',
  '/css/style.css',
  ...
  '/js/sections/maths.js',
  '/data/maths-curriculum.json',
  '/js/sections/writing.js',
  '/js/writing-feedback.js',
  '/js/sections/story-sequence.js',
  '/data/story-sequence.json',
